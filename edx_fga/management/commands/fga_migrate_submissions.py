"""
Django command which migrates existing FGA submissions for a course from all
old FGA implementation before v0.4.0 to newer version that uses the
...
class Command(BaseCommand):
    """
    Migrates existing FGA submissions for a course from old FGA implementation
